...
describe Book do
  ...
  it "has a default status of available" do
    book = Book.new("Ulysses", "James Joyce")
...
describe Library do
  ...
  it "does not allow a book to be checked out twice in a row" do
    lib = Library.new
    # Not sure how to handle non-instantiated objects outside of the code:
  ...
  it "returns borrowed books" do
    ...
    # INCORRECT: book = lib.check_out_book(lib.borrowed_books.first.id, kors)
